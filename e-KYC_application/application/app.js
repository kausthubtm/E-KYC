...
async function main() {
	try {
		...
		try {
			...
			result = await contract.submitTransaction('CreateCustomer', '13', 'Narayan', 'M', '2424', '1300', 'xyz');
			...
			result = await contract.evaluateTransaction('CustomerExists', 'asset1');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);

			console.log('\n--> Submit Transaction: UpdateAsset asset1, change the appraisedValue to 350');
			await contract.submitTransaction('UpdateCustomer', '1', 'Stafan', 'M', '123', '456', 'xyz');
			console.log('*** Result: committed');
			...
			try {
				...
				await contract.submitTransaction('UpdateCustomer', '70', 'kausthub', 'M', '522', '2342', 'abc');
			...
			await contract.submitTransaction('TransferCustomer', '1', '789');
			console.log('*** Result: committed');
			...
			console.log('\n--> Evaluate Transaction: GetAllAssets, function returns all the current assets on the ledger');
			result = await contract.evaluateTransaction('GetAllCustomers');
			console.log(`*** Result: ${prettyJSONString(result.toString())}`);
